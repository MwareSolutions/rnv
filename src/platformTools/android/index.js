...
export const packageAndroid = (c, platform) => new Promise((resolve, reject) => {
    ...
    executeAsync(c, `${reactNative} bundle --platform android --dev false --assets-dest ${appFolder}/app/src/main/res --entry-file ${c.buildConfig.platforms[c.platform]?.entryFile}.js --bundle-output ${appFolder}/app/src/main/assets/${outputFile}.bundle --sourcmap-output ${appFolder}/app/src/main/assets/${outputFile}.bundle.map`)
        .then(() => {
