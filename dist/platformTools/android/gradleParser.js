...
(0,_common.writeCleanFile)((0,_common.getBuildFilePath)(c,platform,'build.gradle'),_path.default.join(appFolder,'build.gradle'),[
...
c.pluginConfigAndroid.minSdkVersion=(0,_common.getConfigProp)(c,platform,'minSdkVersion',21);
c.pluginConfigAndroid.targetSdkVersion=(0,_common.getConfigProp)(c,platform,'targetSdkVersion',28);
c.pluginConfigAndroid.compileSdkVersion=(0,_common.getConfigProp)(c,platform,'compileSdkVersion',28);
c.pluginConfigAndroid.supportLibVersion=(0,_common.getConfigProp)(c,platform,'supportLibVersion','28.0.0');
c.pluginConfigAndroid.buildToolsVersion=(0,_common.getConfigProp)(c,platform,'buildToolsVersion','28.0.0');
...
keystorePathFull=_path.default.join(c.paths.workspace.appConfig.dir,keystorePath);
}else{
...
_fs.default.writeFileSync(genPropsPath,"# auto generated by ReNative\nstoreFile="+
keystorePathFull+"\nkeyAlias="+
...
_chalk.default.white(keystorePathFull)+" does not exist. You won't be able to make production releases without it!");
...
var versionCodeOffset=(0,_common.getConfigProp)(c,platform,'versionCodeOffset',0);
...
(0,_common.writeCleanFile)((0,_common.getBuildFilePath)(c,platform,'app/build.gradle'),_path.default.join(appFolder,'app/build.gradle'),[
...
{pattern:'{{VERSION_CODE}}',override:(0,_common.getAppVersionCode)(c,platform)},
{pattern:'{{VERSION_NAME}}',override:(0,_common.getAppVersion)(c,platform)},
...
(0,_common.writeCleanFile)((0,_common.getBuildFilePath)(c,platform,'settings.gradle'),_path.default.join(appFolder,'settings.gradle'),[
...
(0,_common.writeCleanFile)((0,_common.getBuildFilePath)(c,platform,gradleProperties),_path.default.join(appFolder,gradleProperties),[
...
var injectPluginGradleSync=function injectPluginGradleSync(c,plugin,key,pkg){var _buildGradle$allproje,_buildGradle$buildscr,_buildGradle$buildscr2;
...
plugin.projectName+"').projectDir = new File(rootProject.projectDir, '"+
modulePath+"')\n";
}
...
var buildGradle=_path.default.join(c.paths.project.dir,modulePath,'build.gradle');

if(_fs.default.existsSync(buildGradle)){
(0,_logger.logDebug)('FIX:',buildGradle);
(0,_common.writeCleanFile)(buildGradle,buildGradle,[
