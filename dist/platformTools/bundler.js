...
var _isBundlerRunning=function _isBundlerRunning(c){var _ref,data;return _regenerator.default.async(function _isBundlerRunning$(_context){while(1){switch(_context.prev=_context.next){case 0:
(0,_logger.logTask)("_isBundlerRunning:"+c.platform);_context.prev=1;_context.next=4;return _regenerator.default.awrap(

_axios.default.get("http://"+c.runtime.localhost+":"+c.runtime.port+"/"+(0,_common.getConfigProp)(c,c.platform,'entryFile')+".js"));case 4:_ref=_context.sent;data=_ref.data;if(!
...
false);case 14:case"end":return _context.stop();}}},null,null,[[1,11]]);};
...
false);case 10:case"end":return _context2.stop();}}},null,null,[[1,7]]);};exports.isBundlerActive=isBundlerActive;
...
spinner.fail('Can\'t connect to bundler. Try restarting it.');
reject(_context3.t0);case 11:case"end":return _context3.stop();}}},null,null,[[0,7]]);};
