...
var _templateTools=require("../templateTools");function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_defineProperty2.default)(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}
...
_runCopyPlatforms(c,c.platform));case 9:case"end":return _context.stop();}}});};exports.rnvPlatformConfigure=rnvPlatformConfigure;


var updateProjectPlatforms=function updateProjectPlatforms(c,platforms){var
config=c.paths.project.config;
...
var rnvPlatformSetup=function rnvPlatformSetup(c){var _c$files$project$conf;var currentPlatforms,_ref,inputSupportedPlatforms;return _regenerator.default.async(function rnvPlatformSetup$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:
...
choices:_constants.SUPPORTED_PLATFORMS}));case 3:_ref=_context2.sent;inputSupportedPlatforms=_ref.inputSupportedPlatforms;


updateProjectPlatforms(c,inputSupportedPlatforms);case 6:case"end":return _context2.stop();}}});};exports.rnvPlatformSetup=rnvPlatformSetup;
...
var rnvPlatformEject=function rnvPlatformEject(c){var _ref2,ejectedPlatforms,ptfn,rptf,prf,copyShared;return _regenerator.default.async(function rnvPlatformEject$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:
...
type:'checkbox',
choices:_generatePlatformChoices(c).map(function(choice){return _objectSpread({},choice,{disabled:!choice.isConnected});})}));case 3:_ref2=_context3.sent;ejectedPlatforms=_ref2.ejectedPlatforms;
...
c.files.project.config.platformTemplatesDirs[ejectedPlatforms[0]])+" now. You can edit them directly!");case 7:case"end":return _context3.stop();}}});};exports.rnvPlatformEject=rnvPlatformEject;
...
var rnvPlatformConnect=function rnvPlatformConnect(c){var _ref3,connectedPlatforms,_ref4,deletePlatformFolder,pathsToRemove;return _regenerator.default.async(function rnvPlatformConnect$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:
...
type:'checkbox',
choices:_generatePlatformChoices(c).map(function(choice){return _objectSpread({},choice,{disabled:choice.isConnected});})}));case 3:_ref3=_context4.sent;connectedPlatforms=_ref3.connectedPlatforms;



if(connectedPlatforms.length){
connectedPlatforms.forEach(function(platform){var _c$files$project$conf2;
if((_c$files$project$conf2=c.files.project.config.platformTemplatesDirs)==null?void 0:_c$files$project$conf2[platform]){
...
type:'confirm',
message:'Would you also like to delete the previously used platform folder?'}));case 8:_ref4=_context4.sent;deletePlatformFolder=_ref4.deletePlatformFolder;if(!
...
(0,_logger.logSuccess)(
_chalk.default.white(connectedPlatforms.join(','))+" now using ReNative platformTemplates located in "+_chalk.default.white(c.paths.rnv.platformTemplates.dir)+" now!");case 16:case"end":return _context4.stop();}}});};exports.rnvPlatformConnect=rnvPlatformConnect;
...
var isPlatformSupported=function isPlatformSupported(c){var _c$files$project$conf3,_c$files$project$conf4;var platformsAsObj,opts,_ref5,platform,configuredPlatforms,_ref6,confirm,newPlatforms;return _regenerator.default.async(function isPlatformSupported$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:
...
logMessage:'You need to specify platform'}));case 7:_ref5=_context5.sent;platform=_ref5.platform;
...
(0,_prompt.inquirerPrompt)({
type:'confirm',
message:"Looks like platform "+c.platform+" is not supported by your project. Would you like to enable it?"}));case 14:_ref6=_context5.sent;confirm=_ref6.confirm;if(!
...
c.platform);case 28:case"end":return _context5.stop();}}});};exports.isPlatformSupported=isPlatformSupported;
