...
}));case 18:_await$inquirer$promp=_context.sent;confirm=_await$inquirer$promp.confirm;
...
}));case 39:_await$inquirer$promp3=_context.sent;confirmCache=_await$inquirer$promp3.confirmCache;
