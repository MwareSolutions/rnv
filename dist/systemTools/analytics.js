...
Redash=function(){function Redash(){(0,_classCallCheck2.default)(this,Redash);}(0,_createClass2.default)(Redash,[{key:"captureEvent",value:function captureEvent(
e){
var defaultProps={
...
return _axios.default.post(_constants.REDASH_URL,_objectSpread({},e,{},defaultProps),{
headers:{
...
this.knowItAll=null;
}(0,_createClass2.default)(Analytics,[{key:"initialize",value:function initialize()
...
}},{key:"captureException",value:function captureException(

e){var _this=this;var context=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};
if(_config.default.isAnalyticsEnabled&&this.errorFixer){
this.errorFixer.withScope(function(scope){var _context$extra=
context.extra,extra=_context$extra===void 0?{}:_context$extra,_context$tags=context.tags,tags=_context$tags===void 0?{}:_context$tags;
scope.setTags(_objectSpread({},tags,{os:_os.default.platform()}));
scope.setExtras(_objectSpread({},extra,{fingerprint:(0,_nodeMachineId.machineIdSync)()}));
...
}},{key:"captureEvent",value:function captureEvent(

e){return _regenerator.default.async(function captureEvent$(_context){while(1){switch(_context.prev=_context.next){case 0:if(!(
...
true);case 3:case"end":return _context.stop();}}},null,this);}},{key:"teardown",value:function teardown()
