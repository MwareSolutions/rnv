var _interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports,"__esModule",{value:true});exports.getWorkspaceOptions=exports.rnvWorkspaceUpdate=exports.rnvWorkspaceConnect=exports.getWorkspaceDirPath=exports.createWorkspace=exports.rnvWorkspaceAdd=exports.rnvWorkspaceList=void 0;var _regenerator=_interopRequireDefault(require("@babel/runtime/regenerator"));var _chalk=_interopRequireDefault(require("chalk"));
...
(0,_logger.logToSummary)("Workspaces:\n\n"+opts.asString);case 3:case"end":return _context.stop();}}});};exports.rnvWorkspaceList=rnvWorkspaceList;


var rnvWorkspaceAdd=function rnvWorkspaceAdd(c){var _ref,workspace,workspacePath,_ref2,confirm,workspaceID,_ref3,workspaceIDInput;return _regenerator.default.async(function rnvWorkspaceAdd$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:
...
validate:function validate(i){return!!i||'No path provided';}}));case 3:_ref=_context2.sent;workspace=_ref.workspace;
...
name:'confirm',
type:'confirm',
message:"Folder "+workspacePath+" already exists are you sure you want to override it?"}));case 9:_ref2=_context2.sent;confirm=_ref2.confirm;if(
...
type:'input',
message:"ID of the workspace ("+workspaceID+")"}));case 16:_ref3=_context2.sent;workspaceIDInput=_ref3.workspaceIDInput;


workspaceID=workspaceIDInput||workspaceID;
createWorkspace(c,workspaceID,workspacePath);case 20:case"end":return _context2.stop();}}});};exports.rnvWorkspaceAdd=rnvWorkspaceAdd;
...
true);case 6:case"end":return _context3.stop();}}});};exports.createWorkspace=createWorkspace;


var getWorkspaceDirPath=function getWorkspaceDirPath(c){var _c$buildConfig,_c$buildConfig2,_c$buildConfig2$paths;var wss,ws,dirPath,_wss$workspaces$ws,wsDir,confirm,_ref4,conf,_c$buildConfig3,_c$buildConfig3$paths;return _regenerator.default.async(function getWorkspaceDirPath$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:
...
(wss==null?void 0:wss.workspaces)&&ws)){_context4.next=25;break;}
...
warningMessage:'No app configs found for this project'}));case 18:_ref4=_context4.sent;conf=_ref4.conf;
...
dirPath);case 29:case"end":return _context4.stop();}}});};exports.getWorkspaceDirPath=getWorkspaceDirPath;


var rnvWorkspaceConnect=function rnvWorkspaceConnect(c){var _c$files$rnv$configWo2;var opts,_ref5,selectedWS;return _regenerator.default.async(function rnvWorkspaceConnect$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:
...
choices:opts}));case 4:_ref5=_context5.sent;selectedWS=_ref5.selectedWS;case 6:case"end":return _context5.stop();}}});};exports.rnvWorkspaceConnect=rnvWorkspaceConnect;
...
(0,_logger.logTask)('rnvWorkspaceUpdate');case 1:case"end":return _context6.stop();}}});};exports.rnvWorkspaceUpdate=rnvWorkspaceUpdate;
