...
validate:function validate(i){return!!i||'No path provided';}}));case 3:_await$inquirerPrompt=_context2.sent;workspace=_await$inquirerPrompt.workspace;
...
name:'confirm',
type:'confirm',
message:"Folder "+workspacePath+" already exists are you sure you want to override it?"}));case 9:_await$inquirerPrompt2=_context2.sent;confirm=_await$inquirerPrompt2.confirm;if(
...
type:'input',
message:"ID of the workspace ("+workspaceID+")"}));case 16:_await$inquirerPrompt3=_context2.sent;workspaceIDInput=_await$inquirerPrompt3.workspaceIDInput;
...
warningMessage:'No app configs found for this project'}));case 18:_await$inquirerPrompt4=_context4.sent;conf=_await$inquirerPrompt4.conf;
...
choices:opts}));case 4:_await$inquirerPrompt5=_context5.sent;selectedWS=_await$inquirerPrompt5.selectedWS;case 6:case"end":return _context5.stop();}}},null,null,null,Promise);};exports.rnvWorkspaceConnect=rnvWorkspaceConnect;
