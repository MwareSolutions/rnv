...
if(!c)c=_config2.default.getConfig();var _c=
c,paths=_c.paths;
this.os=os;
this.c=c;
...
(0,_configParser.configureRnvGlobal)(this.c));case 16:case"end":return _context2.stop();}}},null,this);}},{key:"downloadSdk",value:function downloadSdk(
...
sdk,skipPrereq){return _regenerator.default.async(function installSdk$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:
...
this.postInstall(sdk);case 30:case"end":return _context6.stop();}}},null,this);}},{key:"installTizenSdk",value:function installTizenSdk(){return _regenerator.default.async(function installTizenSdk$(_context7){while(1){switch(_context7.prev=_context7.next){case 0:
...
true);case 2:case"end":return _context7.stop();}}});}},{key:"installWebosSdk",value:function installWebosSdk(){return _regenerator.default.async(function installWebosSdk$(_context8){while(1){switch(_context8.prev=_context8.next){case 0:
...
true);case 2:case"end":return _context8.stop();}}});}},{key:"installFastlane",value:function installFastlane(){return _regenerator.default.async(function installFastlane$(_context9){while(1){switch(_context9.prev=_context9.next){case 0:
...
true);case 2:case"end":return _context9.stop();}}});}},{key:"installDocker",value:function installDocker(){return _regenerator.default.async(function installDocker$(_context10){while(1){switch(_context10.prev=_context10.next){case 0:




(0,_logger.logError)('Install docker not supported yet');return _context10.abrupt("return",
true);case 2:case"end":return _context10.stop();}}});}},{key:"askToInstallSDK",value:function askToInstallSDK(


sdk){var sdkInstall,response;return _regenerator.default.async(function askToInstallSDK$(_context11){while(1){switch(_context11.prev=_context11.next){case 0:if(

this.c.program.ci){_context11.next=5;break;}_context11.next=3;return _regenerator.default.awrap(
_inquirer.default.prompt([{
name:'sdkInstall',
type:'confirm',
message:"Do you want to install "+sdk+" SDK?"}]));case 3:response=_context11.sent;
...
new Error("You can't run the project on this platform without "+sdk+" sdk installed"));case 11:case"end":return _context11.stop();}}},null,this);}}]);return BasePlatformSetup;}();var _default=
